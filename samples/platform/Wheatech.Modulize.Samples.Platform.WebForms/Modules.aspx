...
<asp:Content runat="server" ContentPlaceHolderID="main">
    <asp:Panel runat="server" class="alert alert-warning" ID="panelWarning">
        There are some modules installed or uninstalled, and the application requires to be <asp:LinkButton runat="server" Text="restarted" ID="buttonRestart" OnClick="buttonRestart_OnClick"></asp:LinkButton>.
    </asp:Panel>
    <asp:Button runat="server" ID="buttonRefresh" OnClick="buttonRefresh_OnClick" CssClass="hidden"/>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade in active" id="tabpane-modules">
            <ul class="media-list">
                <asp:Repeater runat="server" ID="repeaterModules" ItemType="Wheatech.Modulize.ModuleDescriptor" OnItemDataBound="repeaterModules_OnItemDataBound" OnItemCommand="repeaterModules_OnItemCommand">
                    <ItemTemplate>
        ...
        <div role="tabpanel" class="tab-pane fade in" id="tabpane-features">
            <ul class="media-list">
                <asp:Repeater runat="server" ID="repeaterFeatures" ItemType="Wheatech.Modulize.FeatureDescriptor" OnItemDataBound="repeaterFeatures_OnItemDataBound" OnItemCommand="repeaterFeatures_OnItemCommand">
                    <ItemTemplate>

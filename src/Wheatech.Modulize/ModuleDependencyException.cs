...
{
    /// <summary>
    /// The exception thrown when the modules or features dependency validation has an error.
    /// </summary>
    [Serializable]
    public class ModuleDependencyException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleDependencyException"/> class with a specified error message.
        /// </summary>
        ...
        /// </param>
        public ModuleDependencyException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleDependencyException"/> class with serialized data.
        /// </summary>
        /// <param name="info">
